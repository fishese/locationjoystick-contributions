...
fun CaptureCoordinatesRoute(
    ...
    CaptureCoordinatesScreen(
        ...
        passThroughBrowserName = selectedBrowser?.label ?: "No browser found",
    ...
    if (showBrowserPicker) {
        AlertDialog(
            ...
            title = { Text("Pass-through browser") },
            text = {
                Column {
            ...
            confirmButton = { TextButton(onClick = { showBrowserPicker = false }) { Text("Cancel") } },
        )
    }
}
