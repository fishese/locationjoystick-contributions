                    ...
                    isPlaying -> {
                        IconButton(onClick = onPauseReplay) {
                            Crossfade(
                                ...
                                Icon(icon, contentDescription = "Pause")
                            }
                        }
                    ...
                    isPaused -> {
                        IconButton(onClick = onResumeReplay) {
                            Crossfade(
                                ...
                                Icon(icon, contentDescription = "Resume")
                            }
                        }
                        IconButton(onClick = onStopReplay) {
                            Icon(LjIcons.Stop, contentDescription = "Stop")
                        ...
                        IconButton(onClick = { showStartDialog = true }) {
                            Crossfade(
                                ...
                                Icon(icon, contentDescription = "Start route")
                            }
                        }
                    }
                }
            ...
            Row {
                TextButton(
                    onClick = {
                        ...
                        Toast.makeText(context, "Copied coordinates", Toast.LENGTH_SHORT).show()
                    },
                ) {
                    Text("Copy")
                }
