            ...
            Column(
                    ...
                    Row(
                        ...
                        if (!hideTeleportFeatures) {
                            Button(
                                ...
                                Text("Teleport", maxLines = 1, overflow = TextOverflow.Ellipsis)
                            }
                        }
                        OutlinedButton(
                            ...
                            Text("Walk", maxLines = 1, overflow = TextOverflow.Ellipsis)
                        }
                        OutlinedButton(
                            ...
                            Text("Walk via roads", maxLines = 1, overflow = TextOverflow.Ellipsis)
                        }
                    }
                } else {
                    Text(
                        text = "${points.size} valid points · Route actions",
                ...
                Row(
                    ...
                    OutlinedButton(
                        ...
                        Text(
                            if (isRouteInput) "Save first as favorite" else "Save favorite",
                            maxLines = 1,
                    ...
                    if (isRouteInput) {
                        OutlinedButton(
                            ...
                            Text("Save route", maxLines = 1, overflow = TextOverflow.Ellipsis)
                        }
                    }
                }
                if (isRouteInput) {
